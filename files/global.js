...
jsImport = function(src,cache){
	...
	switch(src){
		case 'dhadmin.list':{
			...
			importJavaScript('./DhContent/ContentContainer.js',cache);
			importJavaScript('./DhContent/List.js',cache);
			improtStyle('/2013admin/css/g.css');
			improtStyle('/2013admin/css/g_mod.css');
			break;
		}
		case 'dhadmin.tree' :{
			jsImport('artdialog',cache);
			importJavaScript('./files/DhContent/ContentContainer.js',cache);
			importJavaScript('./files/DhContent/Tree.js',cache);
			improtStyle('/files/g.css');
			improtStyle('/files/g_mod.css');
			break;
		}
		case 'dhadmin.former':{
			if(typeof $ .fn .validate == 'undefined')   importJavaScript('./files/jquery.validate.js',false);
			if(typeof $ .fn .ajaxSubmit == 'undefined') importJavaScript('./files/jquery.form.min.js',false);
			importJavaScript('./DhFormer.js',cache);
			improtStyle('/files/g.css');
			improtStyle('/files/g_mod.css');
			break;
		}
		case 'artdialog'	:{
			...
			importJavaScript('./files/artDialog.js',false);
			importJavaScript('./files/iframeTools.source.js',false);
			improtStyle		('./files/default.css');
			break; 
		}
		default	:{
